...
namespace Test_Average
{
    public partial class Form1 : Form
    {
        ...
        private double Average(int[] iArray)
        {
            ...
            // Step throught the array, adding each element to
            // the accumulator.
        ...
        private int Highest(int[] iArray)
        {
            ...
            // element 1. When a value greather than highest is found,
            // assign tha vlue to highest.
        ...
        // and truent the lowest value in that array.
        private int Lowest(int[] iArray)
        {
            // Declare a variable to hold the lowest value, and
            // initalize it witht he first value in the array.
            int lowest = iArray[0];

            // Step through the rest of the array, beginning at
            // element 1. When a value less than lowest in found,
