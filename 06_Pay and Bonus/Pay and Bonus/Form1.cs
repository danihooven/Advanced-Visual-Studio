...
namespace Pay_and_Bonus
{
    public partial class Form1 : Form
    {
        ...
        // it in the arugments (passed by reference). If the conversion
        // is successful, the method returns true. Otehrwise it returns
        // false.
        private bool InputIsValid(ref decimal pay, ref decimal bonus)
        {
            ...
            if (decimal.TryParse(grossPayTextBox.Text, out pay))
            {
                ...
                {
                    // Display an erroe message for the bonus.
